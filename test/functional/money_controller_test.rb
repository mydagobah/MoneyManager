...
class MoneyControllerTest < ActionController::TestCase
  ...
  test "should create money" do
    assert_difference('Money.count') do
      post :create, money: { description: @money.description, user_id: @money.user_id, value: @money.value }
    end
  ...
  test "should update money" do
    put :update, id: @money, money: { description: @money.description, user_id: @money.user_id, value: @money.value }
    assert_redirected_to money_path(assigns(:money))
  end
